...
_landing pages, SEO, tráfego, prospecção, copy, redes sociais._ Gerado automaticamente a partir do Punk Records — 40 item(ns). Para aproveitar este tema em outro projeto, leia esta página; abra o item só quando precisar do detalhe.

## [FAQ do MazyOS: instalação, planos do Claude, hospedagem, galerias de referência, venda de sites e integrações](../article/2026-09-14_faq-do-mazyos-instalacao-planos-do-claude-hospedagem-galeria_9ae37bed516d.md)
2026-09-14 · article · SaaS media · cliente alta · estudo media · triagem apply_client · `mazyos` `claude-code` `venda-de-sites` `galerias-de-referencia` `hospedagem-de-site` `recorrencia-de-site`

FAQ da comunidade MazyOS: erro clássico da pasta aninhada, Pro até o primeiro cliente, Vercel/Netlify com domínio na Hostinger, mais de vinte galerias de referência e GSAP grátis, recorrência de 2% a 5% ao mês e API ofic
...
2026-09-10 · tiktok · SaaS media · cliente alta · estudo media · triagem apply_client · `landing-page` `seo` `open-graph` `metadados` `google-search-console`
...
Portfólio não vende: mande o site da empresa pronto já no primeiro contato.
...
## [Shopify — registro de domínios integrado à loja (hospedagem inclusa, DNS automático)](../article/2026-08-27_shopify-registro-de-dominios-integrado-a-loja-hospedagem-inc_f30966ea0cdb.md)
...
## [Estratégia de Prospecção Ativa Internacional para Criação de Sites](../tiktok/2026-08-26_estrategia-de-prospeccao-ativa-internacional-para-criacao-de_7678376368752692487.md)
2026-08-26 · tiktok · SaaS baixa · cliente alta · estudo media · triagem apply_client · `cold-outreach` `lead-generation` `google-maps-scraping` `freelance-sales` `web-development-sales`

Muitas empresas locais bem avaliadas no Google Maps perdem oportunidades comerciais por não possuírem um site próprio.

## [Checklist de 7 configurações essenciais para landing pages feitas com IA](../tiktok/2026-08-26_checklist-de-7-configuracoes-essenciais-para-landing-pages-f_7671505270237023509.md)
2026-08-26 · tiktok · SaaS alta · cliente alta · estudo media · triagem archive · `landing-page-cro` `seo-tecnico` `json-ld` `web-performance` `google-analytics` `microsoft-clarity`

Muitos desenvolvedores geram landing pages via IA e esquecem configurações básicas essenciais para publicação e ranqueamento.
