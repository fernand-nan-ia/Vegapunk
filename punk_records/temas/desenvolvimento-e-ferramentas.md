...
2026-09-12 · article · SaaS media · cliente alta · estudo media · triagem apply_client · `netlify` `powered-by-netlify` `marca-de-terceiro` `site-de-cliente` `plano-free` `script-injetado-na-borda`
...
Gerador de sites de documentação da Meta: Markdown vira site estático com docs versionados, blog e busca.
