---
item_id: "519f9dd0-2a5e-4bdd-8ec4-97ebb962eef6"
platform: article
external_id: "b9493ae2aecf"
...
# Direito autoral para designers: proteção automática, registro como prova e tipos de licença

🔗 https://avctoris.com/direito-autoral-para-designers

## Resumo

Artigo da plataforma Avctoris voltado a designers, cobrindo o que é protegido, como provar autoria e como licenciar. Afirma que projetos gráficos, layouts, identidades visuais, ilustrações e diagramações são obras protegidas automaticamente no momento da criação, sem necessidade de registro — mas insiste que o registro é o que permite comprovar o direito em juízo ou em pedidos administrativos de remoção de conteúdo, funcionando como prova de anterioridade. Faz a distinção que mais importa comercialmente: vender um projeto para um cliente transfere implicitamente os direitos patrimoniais, a menos que exista contrato de licenciamento dizendo o contrário; sem contrato específico, a Justiça tende a entender que houve cessão. Licenciar não é transferir, e quem licencia continua titular e pode conceder outras licenças. Detalha os tipos de licença — exclusiva, não exclusiva, gratuita, royalty-free — e recomenda especificar duração, território, tipo de uso e modificações permitidas. Alerta que usar referência e inspiração não infringe, desde que a obra final seja única e original, mas que cópia total ou parcial é ilícita. Traz um ponto operacional relevante: como sites de templates e elementos gráficos licenciam de forma não exclusiva por padrão, é expressamente proibido registrar no INPI como marca um logotipo feito no Canva, porque o registro dá exclusividade e isso conflita com a licença não exclusiva. Fecha com ferramentas de proteção — registro autoral, registro de marca no INPI feito pelo cliente, contratos bem redigidos, metadados de copyright e serviços de rastreamento. O artigo é comercial: a Avctoris vende o serviço de registro que recomenda.

## Tópicos

- **Proteção automática, prova não** — A obra nasce protegida sem registro, mas o registro é o que sustenta a comprovação judicial e administrativa.
- **Referência não é plágio** — Usar inspiração é lícito desde que a obra final seja única e original; cópia total ou parcial não.
- **Venda ao cliente transfere** — Sem contrato de licenciamento explícito, entende-se cessão dos direitos patrimoniais ao cliente.
- **Licenciar × transferir** — Quem licencia mantém titularidade e pode licenciar de novo; quem cede, não.
- **Tipos de licença** — Exclusiva, não exclusiva, gratuita e royalty-free; a licença deve especificar duração, território, tipo de uso e modificações.
- **Canva e INPI** — Logotipo feito com elementos de biblioteca não pode ser registrado como marca, porque exclusividade conflita com licença não exclusiva.
- **Direitos morais são inegociáveis** — Mesmo cedendo os patrimoniais, o designer segue autor e pode exigir crédito; uso fora do acordado gera indenização.

## Ferramentas citadas

- **Avctoris**: plataforma paga de registro de obra autoral por hashcode, válida em 181 países pela Convenção de Berna; é a anunciante do artigo
- **INPI**: registro de marca, que protege nome e logotipo na classe da atividade e deve ser feito pelo cliente
- **Creative Commons**: licenças padronizadas para uso livre com condições
- **Canva**: exemplo de plataforma cuja licença padrão não exclusiva impede registro de marca do logotipo gerado

## Pontos-chave

- Layout, identidade visual e diagramação são obras protegidas desde a criação, sem registro.
- Ter o direito e conseguir provar o direito são coisas diferentes — o registro serve para a segunda.
- Inspiração e referência são lícitas; o que separa é a obra final ser original.
- Vender o projeto ao cliente transfere os patrimoniais por padrão, salvo contrato de licença em contrário.
- Licença deve especificar duração, território, tipo de uso e se pode modificar.
- Se o cliente usar além do que a licença permite, mesmo tendo pago, deve indenizar.
- Logotipo com elementos de biblioteca (Canva e similares) não pode ser registrado como marca.
- Registro de marca no INPI deve ser feito pelo cliente, não pelo designer.
- Direitos morais são intransferíveis: o autor pode exigir crédito mesmo depois de ceder tudo.
- O artigo é peça comercial da própria plataforma de registro que recomenda.

## Como aplicar

Define o que precisa estar no contrato dos sites vendidos: sem cláusula, o cliente fica com os direitos patrimoniais do layout entregue, o que impede reaproveitar aquele design em outro cliente. Se a intenção é montar um catálogo de produtos reutilizáveis, o contrato tem que dizer licença de uso, não cessão — essa é a diferença entre vender um site e vender o mesmo modelo dez vezes. E confirma pelo lado de fora o que o item do Vilage diz por dentro: identidade montada com elementos de biblioteca não vira marca registrável do cliente.

## 🪖 Shaka diz

Metade evidência, metade anúncio — a Avctoris vende o registro que o texto recomenda, e isso precisa ficar anotado. A parte que sobrevive ao filtro é contratual e vale dinheiro para você: sem cláusula escrita, vender o site significa ceder os direitos patrimoniais daquele layout. Se pretende revender o mesmo modelo, o contrato precisa dizer licença de uso, não cessão. Decida isso antes do primeiro cliente pagante, não depois.
...
Tags: designers direito autoral registro autoral
