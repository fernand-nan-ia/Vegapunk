---
item_id: "edf63779-7322-4e8f-ba63-7fb73f16b517"
platform: article
external_id: "526d9b6784b1"
...
# CFM atualiza resolução da publicidade médica (reprodução do CREMEB, com erro de numeração)

🔗 https://www.cremeb.org.br/index.php/noticias/cfm-atualiza-resolucao-da-publicidade-medica

## Resumo

Reprodução, pelo Conselho Regional de Medicina do Estado da Bahia, da nota oficial do CFM sobre a Resolução 2.336/2023. O conteúdo é substancialmente idêntico ao da nota do portal do CFM já arquivada: três anos de processo, consulta pública com mais de 2.600 sugestões, quatro webinários, e o detalhamento das regras de uso de imagem de paciente. Traz um erro de numeração: em uma passagem chama a norma de Resolução CFM nº 2.333/23, quando o número correto é 2.336/23 — o próprio texto usa o número certo nos demais parágrafos. Item guardado apenas para registrar a duplicidade e o erro; a fonte a consultar é a nota do portal do CFM ou, melhor, o texto integral da resolução.

## Pontos-chave

- Conteúdo substancialmente idêntico à nota do portal do CFM já arquivada
- Contém erro de numeração: cita 2.333/23 onde o correto é 2.336/23
- Não acrescenta nenhuma informação às fontes primárias
- Serve de lembrete de que reprodução de conselho regional pode introduzir erro

## Como aplicar

Não usar. A fonte correta é o texto integral da Resolução 2.336/2023 e o Manual da Codame, ambos já arquivados.

## 🧠 Stella diz

Ora bolas, moço, é a mesma nota do CFM copiada e colada — e no meio da cópia trocaram o número da resolução. Eu cá descarto, mas guardo a lição: quando um conselho regional reproduz o federal, o texto pode chegar com dígito errado. Vá sempre na fonte, que aqui já está arquivada inteira.
...
CONFIRA AQUI a Resolução CFM nº 2.336/2023, que entrará em vigor em 180 dias a contar do dia 13 de setembro de 2023 – data da publicação no Diário Oficial da União.
...
**Aparelhos** – Também pode anunciar os aparelhos ou recursos tecnológicos usando o portfólio aprovado pela Anvisa e autorizados pelo CFM, desde que não atribua capacidade privilegiada à aparelhagem.
