---
item_id: "4b1b862a-9fa9-4a3f-9057-07c854e76125"
platform: article
external_id: "10733afe4876"
...
# CFM moderniza a resolução da publicidade médica (nota oficial, 2023)

🔗 https://portal.cfm.org.br/noticias/cfm-atualiza-resolucao-da-publicidade-medica

## Resumo

Nota do portal do CFM anunciando a aprovação da Resolução 2.336/2023 e explicando a intenção por trás da mudança. O processo durou mais de três anos, com consulta pública que recebeu mais de 2.600 sugestões, quatro webinários e escuta das sociedades médicas; a plenária que aprovou debateu por mais de onze horas. O relator, conselheiro Emmanuel Fortes — o mesmo que relatou a norma anterior, a 1.974/2011 —, explica que a leitura restritiva dos decretos-lei de 1932 e 1942 tratava de forma desigual a prática de consultório e a hospitalar, e que a revisão passou a permitir ao médico mostrar a amplitude de seus serviços preservando a medicina como atividade-meio. A nota detalha a mudança de maior impacto prático: onde o regramento anterior PROIBIA expressamente o uso de imagem de paciente, o novo permite, desde que com caráter educativo, relacionado à especialidade registrada, acompanhado de texto com indicações terapêuticas e fatores que influenciem negativamente o resultado, sem manipulação ou melhoramento da imagem e sem identificar o paciente. Também passaram a ser autorizados a divulgação de preço de consulta, campanhas promocionais e a publicidade de equipamentos do local de trabalho.

## Tópicos

- **Como a norma foi construída** — Mais de três anos, consulta pública com mais de 2.600 sugestões, quatro webinários, escuta das sociedades médicas e plenária de mais de onze horas de debate.
- **A intenção declarada** — Corrigir a leitura restritiva dos decretos-lei de 1932 e 1942, que tratava de forma desigual a prática de consultório e a hospitalar, permitindo mostrar a amplitude dos serviços sem descaracterizar a medicina como atividade-meio.
- **Imagem de paciente: de proibida a permitida** — Caráter educativo, relacionada à especialidade registrada, com texto sobre indicações e fatores que influenciem negativamente o resultado, sem manipulação e sem identificar o paciente.
- **Outras liberações** — Divulgação de preço de consulta, campanhas promocionais e publicidade dos equipamentos do local de trabalho.

## Pontos-chave

- Fonte oficial do CFM sobre a aprovação da 2.336/2023
- Processo de mais de três anos com 2.600 sugestões em consulta pública
- Relator: conselheiro Emmanuel Fortes, o mesmo da norma anterior de 2011
- Imagem de paciente passou de expressamente proibida a permitida sob condições
- Preço de consulta e campanha promocional passaram a ser permitidos
- A vigência é 180 dias após a publicação de 13/09/2023

## Como aplicar

Serve como contexto e como prova de procedência da norma, não como regra operacional — para isso valem a resolução e o manual. O trecho útil é o da imagem de paciente, que explica em linguagem simples o que a resolução detalha no art. 14.

## 🔧 Atlas diz

Isto aqui é o comunicado, não a peça. Serve para saber de onde veio a regra e por que mudou — três anos e onze horas de plenária, então não é norma feita às pressas. Mas na hora de montar a página, Grr, é o texto da resolução e o manual que ficam abertos na tela, não a notícia.
