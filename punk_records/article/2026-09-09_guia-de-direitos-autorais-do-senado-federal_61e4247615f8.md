---
item_id: "a5941c25-2818-4542-b585-fac8121b19f0"
platform: article
external_id: "61e4247615f8"
...
# Guia de Direitos Autorais do Senado Federal

🔗 https://www12.senado.leg.br/manualdecomunicacao/guia-de-direitos-autorais

## Resumo

Guia oficial do Senado, escrito para a rotina de comunicação, que consolida a Lei 9.610/98 em linguagem direta. Estabelece a regra de partida: como a lei não dá resposta exata para todo caso, a regra é ter autorização para usar. Lista as obras protegidas — textos, fotografias, desenhos e artes plásticas, programas de computador e bases de dados, além de coletâneas quando a organização constitui obra nova — e deixa explícito que ideias não são protegidas, só o que já foi criado. Separa direitos morais, que não se vendem nem prescrevem (ser reconhecido como autor, manter a integridade da obra), de direitos patrimoniais, que dependem de autorização prévia e expressa e podem ser cedidos por contrato interpretado restritivamente: transfere apenas o que estiver escrito. Desmonta o mito do 'pequeno trecho', afirmando que não existe duração ou tamanho que libere uso automático. A parte mais extensa trata de imagem: fotografia é protegida em duas frentes, pelo direito autoral de quem fotografou e pelo direito de imagem de quem aparece, sendo que o segundo não entra em domínio público e pode ser exercido pela família após a morte. Registra que imagem publicada em site oficial ou perfil aberto de rede social continua exigindo autorização, e que estar disseminada na internet não dispensa nada. Sobre bancos de imagem, exige dar crédito à plataforma e ao autor, verificar os termos de licenciamento e checar se há permissão para modificar — corte, edição, montagem e sobreposição em geral exigem autorização específica, porque a lei manda que a reprodução esteja em absoluta consonância com a original. Alerta ainda para evitar imagens que contenham selos, marcas ou logotipos protegidos por propriedade industrial. Prazos: direitos morais são perpétuos, patrimoniais duram 70 anos após a morte do autor ou após a divulgação, no caso de obras fotográficas e audiovisuais.

## Tópicos

- **A regra é autorização** — A lei não resolve todo caso objetivamente, então o padrão é obter autorização prévia e expressa antes de usar.
- **O que é e não é protegido** — Protege textos, fotos, desenhos, software, bases de dados e coletâneas cuja organização seja obra nova; não protege ideias.
- **Morais × patrimoniais** — Morais são intransferíveis e perpétuos; patrimoniais dependem de autorização e podem ser cedidos por contrato, interpretado restritivamente.
- **O mito do pequeno trecho** — A lei não define tamanho; nenhuma duração libera uso automático, e nas redes o trecho curto ainda dispara bloqueio.
- **Dupla proteção da fotografia** — Direito autoral de quem fotografou mais direito de imagem de quem aparece; o segundo não cai em domínio público.
- **Bancos de imagem** — Exigem crédito à plataforma e ao autor, leitura dos termos e verificação da permissão de modificar; corte e montagem pedem autorização específica.
- **Prazos e domínio público** — Morais perpétuos; patrimoniais 70 anos após a morte do autor, ou após a divulgação em obras fotográficas e audiovisuais.

## Ferramentas citadas

- **Lei 9.610/1998**: norma que rege os direitos autorais no Brasil, base de todo o guia

## Pontos-chave

- A regra prática é pedir autorização — a lei não cobre todo caso de forma objetiva.
- Ideias não são protegidas; obras criadas, sim.
- Não existe 'pequeno trecho' automaticamente permitido: nenhum tamanho libera o uso.
- Adquirir uma obra não transfere nenhum direito patrimonial sobre ela.
- Contrato de cessão é interpretado restritivamente — vale só o que está escrito, com suporte, finalidade e prazo especificados.
- Foto tem duas camadas: o direito de quem fotografou e o direito de imagem de quem aparece.
- Estar disseminada na internet, inclusive em perfil oficial, não dispensa autorização.
- Banco de imagem exige crédito à plataforma e ao autor, e checagem se a licença permite modificar.
- Compor uma arte com várias fotos de autores diferentes exige autorização de todos.
- Evitar imagens que contenham selos, marcas ou logotipos protegidos por propriedade industrial.

## Como aplicar

É a régua para o passo que sempre vem depois do clone: trocar as fotos. Confirma que reaproveitar imagem baixada do site alvo é infração dupla (autor e retratado), que foto de perfil aberto de rede social também exige autorização — o que atinge diretamente as seis fotos da VDC capturadas do Instagram na pasta testes-skills-design — e que recortar ou montar imagem de banco pede permissão específica além da licença padrão. Serve também para o depoimento com foto de cliente: precisa de autorização registrada por escrito.

## 🪖 Shaka diz

Fonte oficial, sem interpretação criativa. Anote os dois pontos que atingem o seu trabalho de hoje: as seis fotos da VDC vieram do Instagram, e perfil aberto não dispensa autorização — peça ao cliente por escrito junto com os originais em alta. E o 'pequeno trecho' não existe como salvo-conduto; se for usar texto de terceiro, use com autorização ou não use.
