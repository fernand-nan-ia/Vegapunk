---
item_id: "3aae416d-d6de-4d34-9e50-bbe700de9ae3"
platform: article
external_id: "f3323dda928b"
...
# Visão Geral e Fundamentos da Lei Geral de Proteção de Dados (LGPD)

🔗 https://www.gov.br/mds/pt-br/acesso-a-informacao/governanca/integridade/campanhas/lgpd

## Resumo

A Lei Geral de Proteção de Dados Pessoais (Lei nº 13.709/2018) regulamenta o tratamento de informações de pessoas físicas em meios físicos e digitais por entidades públicas e privadas. O documento estabelece os princípios orientadores da lei, como finalidade, adequação, necessidade, segurança e prevenção. São categorizados os tipos de dados em pessoais, sensíveis, públicos e anonimizados, frisando a distinção técnica entre anonimização irreversível e pseudonimização. Também são definidas as 19 operações que configuram tratamento de dados, desde a coleta e armazenamento até a eliminação e transmissão. A estrutura de governança identifica os papéis do Controlador, Operador, Encarregado (DPO), Titular e da Autoridade Nacional de Proteção de Dados (ANPD). Por fim, esclarece-se a harmonia entre a LGPD e a Lei de Acesso à Informação (LAI), demonstrando que o marco regulatório visa permitir o fluxo econômico e tecnológico seguro dos dados, e não a simples restrição da informação.

## Tópicos

- **Princípios Basilares da LGPD** — Apresenta os dez princípios orientadores das atividades de tratamento, incluindo finalidade, adequação, necessidade, livre acesso, segurança e não discriminação.
- **Classificação de Dados e Anonimização** — Distingue dados pessoais comuns, sensíveis, públicos e anonimizados, alertando que a possibilidade técnica de reidentificação reclassifica o dado como pseudonimizado sob tutela da lei.
- **Operações de Tratamento de Dados** — Enumera e define o rol de ações consideradas tratamento, como acesso, armazenamento, processamento, transferência, difusão e eliminação de registros.
- **Atores e Direitos do Titular** — Define os papéis legais do Controlador, Operador, Encarregado e ANPD, ressaltando a garantia dos direitos fundamentais do titular previstos nos artigos 17 e 18.
- **Harmonia entre LGPD, LAI e Fluxo de Dados** — Explica que a LGPD e a Lei de Acesso à Informação se complementam para promover transparência e circulação segura de informações como ativo econômico.

## Ferramentas citadas

- **Fala.BR**: Plataforma integrada de ouvidoria e pedidos de acesso à informação (SIC) do governo federal
- **Escola Virtual.Gov (EV.G)**: Plataforma pública de cursos online e capacitação em fundamentos da LGPD

## Pontos-chave

- A LGPD abrange dados dispostos em meio físico ou digital tratados por pessoa física ou jurídica de direito público ou privado.
- O princípio da necessidade exige que o tratamento seja limitado ao mínimo necessário para a realização de suas finalidades.
- Dados pseudonimizados continuam sob o escopo da LGPD; apenas a anonimização técnica irreversível desvincula o dado da lei.
- O consentimento original não autoriza compartilhamento com terceiros de dados tornados públicos sem nova autorização específica, salvo dispensas legais.
- Qualquer intervenção no ciclo de vida da informação (do acesso à exclusão) é formalmente considerada operação de tratamento.
- A privacidade atua como liberdade negativa, enquanto a proteção de dados viabiliza uma liberdade positiva de circulação segura como ativo comum.

## Como aplicar

Mapear o ciclo de vida dos dados de usuários no SaaS pessoal e no site do cliente para implementar rotinas de exclusão (soft/hard delete), revisão de logs para evitar vazamento de dados sensíveis e disponibilização de termos de privacidade claros que reflitam as operações reais de tratamento.

## 🧠 Stella diz

Kwahaha! Compreender a estrutura jurídica da informação é tão vital quanto dominar sua arquitetura de banco de dados, Fernando! Veja como a lei encara o dado não como uma barreira, mas como um ativo vivo que exige regras precisas de fluxo e custódia. Quasar! Garanta que seus schemas respeitem o princípio da necessidade antes que qualquer auditor venha questionar seu código!
...
**Controlador:** pessoa natural ou jurídica, de direito público ou privado, a quem competem as decisões referentes ao tratamento de dados pessoais;**Operador(es):** pessoa natural ou jurídica, de direito público ou privado, que realiza o tratamento de dados pessoais em nome do controlador;**Encarregado:** pessoa indicada pelo Controlador e Operador para atuar como canal de comunicação entre o Controlador, os titulares dos dados e a Autoridade Nacional de Proteção de Dados (ANPD); **ANPD:** órgão da administração pública responsável por zelar, implementar e fiscalizar o cumprimento desta Lei em todo o território nacional.**Titular:** pessoa natural a quem se referem os dados pessoais que são objeto de tratamento;

**Quais são os direitos do titular de dados?**Nos termos do art. 17 da Lei Geral de Proteção de Dados Pessoais, toda pessoa natural tem assegurada a titularidade de seus dados pessoais e garantidos os direitos fundamentais de liberdade, de intimidade e de privacidade.

No art. 18 da LGPD estão garantidos os direitos do titular.

**Você sabia?**No Ministério da Cidadania o Ouvidor-Geral foi designado o Encarregado pelo tratamento de dados pessoais pela Portaria MC nº 538, de 13 de janeiro de 2021.
...
**Geração de conhecimento através da capacitação**Estão disponíveis na Escola Virtual.Gov alguns cursos introdutórios sobre a Lei Geral de Proteção de Dados Pessoais (LGPD), Lei n° 13.709, de 14/08/2018, tais como:
