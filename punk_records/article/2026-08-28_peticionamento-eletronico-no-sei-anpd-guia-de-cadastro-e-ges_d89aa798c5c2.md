---
item_id: "af37f9f8-33e6-4364-8abb-cda121705c47"
platform: article
external_id: "d89aa798c5c2"
...
# Peticionamento Eletrônico no SEI/ANPD: Guia de Cadastro e Gestão Processual

🔗 https://www.gov.br/anpd/pt-br/canais_atendimento/peticionamento-eletronico-anpd

## Resumo

A Autoridade Nacional de Proteção de Dados (ANPD) utiliza o Sistema Eletrônico de Informações (SEI), integrante do Processo Eletrônico Nacional, para instruir e tramitar todos os seus processos administrativos de forma 100% digital. O peticionamento eletrônico serve para envio de denúncias por titulares, recebimento de intimações e apresentação de manifestações ou defesas em fiscalizações. Pessoas físicas e jurídicas devem realizar um cadastro prévio em duas etapas obrigatórias: preenchimento dos dados no portal e envio do Termo de Declaração assinado via gov.br ou certificado ICP-Brasil. Cadastros anteriores a 15 de janeiro de 2024 foram invalidados devido à migração para infraestrutura própria da ANPD, exigindo recadastramento para novos acessos ou pedidos intercorrentes. Para pessoas jurídicas, o sistema permite a gestão centralizada de procuradores por CNPJ, distribuindo intimações a todos os outorgados e reduzindo o risco de perda de prazos. O prazo de homologação do cadastro é de até três dias úteis, e o sistema conta com registros oficiais de indisponibilidade para controle de prorrogação tempestiva de prazos legais.

## Tópicos

- **Processo de Cadastro de Usuário Externo** — Exige duas etapas sequenciais: o pré-cadastro online no SEI e o envio por e-mail do Termo de Declaração assinado via gov.br ou ICP-Brasil, com validação em até 3 dias úteis.
- **Recadastramento Obrigatório (Pós-15/01/2024)** — Cadastros anteriores foram cancelados na migração para sistema próprio da ANPD, demandando novo cadastro e solicitação de peticionamento intercorrente para consultar autos antigos.
- **Gestão de Procuradores para Pessoas Jurídicas** — Permite vincular procuradores diretamente ao CNPJ, garantindo que intimações cheguem simultaneamente a múltiplos advogados em todos os processos da empresa.
- **Consulta Pública e Registro de Indisponibilidade** — Módulos para pesquisa processual, validação de autenticidade documental e histórico de indisponibilidade do SEI que fundamenta a prorrogação automática de prazos.

## Ferramentas citadas

- **SEI (Sistema Eletrônico de Informações)**: Sistema de gestão e tramitação de processos administrativos eletrônicos adotado pela ANPD.
- **Assinatura Eletrônica gov.br**: Método aceito para assinatura digital do Termo de Declaração de Concordância e Veracidade.
- **Certificado Digital ICP-Brasil**: Alternativa de certificação digital padrão aceita para autenticar o cadastro do usuário externo.

## Pontos-chave

- O trâmite de denúncias, defesas e intimações da ANPD ocorre exclusivamente em meio digital via SEI.
- O cadastro do usuário externo exige validação obrigatória por assinatura gov.br ou certificado ICP-Brasil antes de ser liberado.
- Cadastros criados antes de 15/01/2024 foram cancelados e requerem recadastramento completo.
- A representação jurídica no SEI é configurada por CNPJ e não por processo individual, mitigando o risco de perda de intimações.
- A análise de liberação de novos cadastros de usuários externos leva até 3 dias úteis pela equipe do protocolo.
- Períodos de indisponibilidade técnica do SEI devidamente registrados justificam a prorrogação legal de prazos processuais.

## Como aplicar

Mantenha o cadastro da pessoa jurídica e dos responsáveis devidamente homologado no SEI da ANPD para responder de forma tempestiva caso ocorra qualquer notificação, incidente de segurança relatado ou denúncia de titular no SaaS ou no cliente.

## 📚 Pythagoras diz

O registro documental é formal e estrito: a ANPD não aceita mais papéis e cancelou credenciais antigas em janeiro de 2024. Deduzo que a negligência nesse cadastro prévio pode inviabilizar o cumprimento de prazos defensivos críticos em caso de incidente de dados. Recomendo validar o credenciamento do seu CNPJ preventivamente antes que surja uma intimação.
...
**NOVO! Importante: o interessado é Pessoa Jurídica?**
