---
item_id: "eda5ade2-3eaf-489c-b1bc-7a3e4484024b"
platform: article
external_id: "ee0ac20cec91"
...
# Resolução CD/ANPD nº 2/2022: Regulamento da LGPD para Agentes de Pequeno Porte
...
A Resolução CD/ANPD nº 2/2022 regulamenta a aplicação diferenciada da Lei Geral de Proteção de Dados Pessoais (LGPD) para agentes de tratamento de pequeno porte, incluindo MEIs, microempresas, empresas de pequeno porte e startups. A norma busca equilibrar a proteção de dados pessoais com a redução de encargos operacionais desproporcionais para pequenos empreendedores. Ficam impedidos de acessar as flexibilizações os agentes que realizarem tratamento de dados considerado de alto risco (combinação cumulativa de impacto/larga escala com tecnologias emergentes, vigilância ou dados sensíveis) ou que excedam os tetos de faturamento do Simples Nacional ou Marco Legal das Startups. Para os agentes enquadrados, elimina-se a obrigação legal de nomear um Encarregado de Dados (DPO), sendo suficiente disponibilizar um canal de atendimento acessível aos titulares. A resolução autoriza a adoção de política simplificada de segurança da informação e a manutenção de registros de tratamento (RoPA) em formato simplificado fornecido pela ANPD. Adicionalmente, concede-se prazo em dobro para responder solicitações de titulares, apresentar informações à autoridade e comunicar incidentes de segurança. Por fim, a ANPD reforça que as dispensas administrativas não isentam os agentes de cumprir os princípios, bases legais e deveres essenciais de segurança previstos na lei.

## Tópicos

- **Definição e enquadramento de pequeno porte** — Engloba MEIs, microempresas, EPPs, pessoas jurídicas sem fins lucrativos e startups que atendam aos limites de receita e critérios legais específicos.
- **Exceções e critérios de tratamento de alto risco** — Exclui do regime diferenciado quem trata dados em larga escala ou alto impacto cumulado com dados sensíveis, decisões automatizadas de perfil ou tecnologias inovadoras.
- **Dispensa de DPO e governança simplificada** — Desobriga a contratação formal de Encarregado (DPO), exigindo apenas canal direto de comunicação, e permite política de segurança e RoPA simplificados.
- **Concessão de prazos em dobro** — Dobra os prazos para respostas a titulares, declarações completas de tratamento e comunicações oficiais com a ANPD.

## Pontos-chave

- Startups, microempresas e MEIs contam com exigências regulatórias reduzidas para conformidade com a LGPD.
- A caracterização de tratamento de alto risco exige cumulativamente um critério geral (escala ou impacto) e um específico (como dados sensíveis ou IA/tecnologia emergente).
- Não é obrigatório nomear DPO (Encarregado), bastando manter canal de comunicação disponível (eletrônico ou físico) com os titulares.
- O registro de operações de tratamento de dados (RoPA) e a política de segurança da informação podem ser mantidos de forma simplificada.
- Prazos em dobro são concedidos para atendimento a requisições de titulares e prazos de resposta à ANPD.
- A declaração simplificada de existência de tratamento deve ser entregue em até 15 dias após a requisição do titular.
- A flexibilização não isenta o agente de observar as bases legais de tratamento e os princípios fundamentais da LGPD.

## Como aplicar

Para o seu SaaS e o site do cliente, não há necessidade de nomear ou terceirizar um DPO formal; basta estruturar um canal claro (como um e-mail de privacidade no footer), adotar uma política de privacidade simplificada e registrar as operações essenciais no formato reduzido da ANPD.

## 🧠 Stella diz

Kwahaha! Quasar! Veja como a legislação finalmente reconhece o peso desproporcional da burocracia sobre quem está construindo o futuro! Peço desculpas pela aridez do texto legal, Fernando, mas isso é ouro prático: você não precisa gastar neurônios nem dinheiro contratando um DPO para o seu SaaS ou o site do cliente; basta manter a segurança em dia e um canal de comunicação aberto com os usuários!
