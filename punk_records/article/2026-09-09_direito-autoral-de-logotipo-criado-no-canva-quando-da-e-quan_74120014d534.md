---
item_id: "e6bf8ad1-844f-46fb-a395-60f1f981dd4e"
platform: article
external_id: "74120014d534"
...
# Direito autoral de logotipo criado no Canva: quando dá e quando não dá para proteger

🔗 https://www.vilage.com.br/blog/direito-autoral-logotipo-criado-no-canva

## Resumo

Artigo da VILAGE Marcas e Patentes que separa duas proteções que o mercado costuma tratar como uma só: direito autoral, que nasce com a criação original e independe de registro, e registro de marca no INPI, que protege o sinal usado para identificar produtos e serviços e depende de pedido e concessão. A tese central é que usar o Canva não impede a proteção — o que decide é o grau de originalidade e quais elementos foram efetivamente usados. Formas simples isoladas não pertencem a ninguém; o que pode ser protegido é a composição, o arranjo próprio de formas, tipografia, cores e proporções. Já ícones, ilustrações, gráficos e símbolos tirados da biblioteca da plataforma nunca serão do usuário: sobre eles existe apenas licença não exclusiva, disponível a todos os demais usuários simultaneamente. O texto compara dois cenários: a empresa que pega um template pronto e troca só o nome fica sem proteção autoral e com registro de marca vulnerável; a empresa que parte de recursos neutros e desenvolve símbolo inédito tem chance real de proteção. Registra que o Canva Pro não muda nada — o plano pago amplia acesso, não concede exclusividade. Traz um alerta pouco conhecido: o INPI não pesquisa bibliotecas de plataformas de design durante o exame, então um pedido com elemento de template pode até ser deferido, e o risco não é o indeferimento e sim a fragilidade posterior do registro, um ativo que parece protegido e não está. Sobre defesa, aponta que concorrência desleal e direito de precedência existem, mas são reativos, caros e de resultado incerto. Fecha com os requisitos práticos do INPI — distintividade, busca de anterioridade, definição de classe pela Classificação de Nice e tipo de marca — sugerindo começar pela marca nominativa, que protege o nome sem elemento figurativo e permite redesenhar o logo depois sem perder proteção. Base legal citada: Leis 9.610/98, 5.988/73 e 9.279/96.

## Tópicos

- **Duas proteções distintas** — Direito autoral nasce com a criação e independe de registro; marca depende de pedido e concessão do INPI e vale só na classe pedida.
- **O que é seu é a composição** — Formas simples não pertencem a ninguém; o arranjo original de formas, tipografia, cores e proporções pode ser obra.
- **Elemento de biblioteca nunca é seu** — Ícones, ilustrações e símbolos da plataforma têm titular; o usuário só tem licença não exclusiva, igual à de todos os outros.
- **Os dois cenários** — Template com nome trocado: sem proteção autoral e marca vulnerável. Símbolo inédito a partir de recursos neutros: proteção viável.
- **Canva Pro não dá exclusividade** — O plano pago amplia acesso a recursos, não transfere autoria nem concede exclusividade sobre nada.
- **O INPI não checa bibliotecas** — O pedido pode ser deferido mesmo com elemento de template; o risco é o registro concedido nascer frágil e anulável.
- **Requisitos do registro** — Distintividade no segmento, busca de anterioridade, classe pela Classificação de Nice e tipo de marca; a nominativa evita a discussão autoral do figurativo.

## Ferramentas citadas

- **Canva**: plataforma cujos elementos de biblioteca vêm sob licença não exclusiva
- **INPI**: órgão do registro de marca; não pesquisa bibliotecas de design no exame
- **Escola de Belas Artes da UFRJ**: onde se registra obra de artes visuais e desenho, não na Biblioteca Nacional
- **Classificação de Nice**: define as classes de produtos e serviços em que a marca fica protegida
- **VILAGE Marcas e Patentes**: escritório autor do artigo, que vende o serviço de registro

## Pontos-chave

- Direito autoral e registro de marca são proteções distintas; um logo pode ter as duas, uma ou nenhuma.
- Usar Canva não impede proteção — o que decide é a originalidade do arranjo.
- Ícone, ilustração e símbolo de biblioteca nunca pertencem ao usuário: licença não exclusiva.
- Template com nome trocado, em regra, não tem proteção autoral.
- Canva Pro não concede exclusividade sobre elemento nenhum.
- O INPI não pesquisa bibliotecas de plataformas; o registro pode ser deferido e nascer anulável.
- A Lei 9.279/96 impede registrar como marca obra artística de terceiro quando há risco de confusão.
- Registro de desenho e artes visuais é na Escola de Belas Artes da UFRJ, não na Biblioteca Nacional.
- Marca nominativa protege o nome sem elemento figurativo e permite redesenhar o logo depois.
- Nome estilizado não é marca nominativa — a estilização o torna figurativo ou misto.

## Como aplicar

Resolve o que dizer ao cliente que chega com logo feito no Canva — situação provável tanto na VDC quanto na psiquiatra. Se a identidade veio de template, ela não é protegível e um registro no INPI nasce frágil, o que é informação que o cliente precisa ter antes de investir em fachada e embalagem. Para o site, a consequência prática é não tratar o logo do cliente como ativo exclusivo dele sem antes checar a origem, e sugerir marca nominativa como primeiro passo, que protege o nome e permite redesenhar depois.

## 🪖 Shaka diz

O ponto que mais gente ignora está aqui: o INPI não olha a biblioteca do Canva durante o exame. Isso significa que o registro sai, o cliente pendura o certificado na parede, e o ativo é anulável — proteção aparente é pior que proteção nenhuma, porque muda decisão de investimento. Quando um cliente seu chegar com logo de template, diga isso antes de ele gastar com fachada.
...
- Mais de 93 mil marcas registradas desde 1986.

- Mais de 40 mil clientes protegidos pelo mundo.
...
### O Canva Pro dá exclusividade sobre os elementos usados?
...
Lei nº 9.610/1998 (Direitos Autorais), artigos 8º, 18 e 19. Lei nº 5.988/1973, artigo 17. Lei nº 9.279/1996 (Propriedade Industrial), artigos 122, 124 (inciso XVII), 129 (§ 1º), 195 e 209. Termos de Uso do Canva vigentes na data desta publicação.*Fonte: Imagem gerada por IA (Gemini) dia 31 de julho, 10h*11
