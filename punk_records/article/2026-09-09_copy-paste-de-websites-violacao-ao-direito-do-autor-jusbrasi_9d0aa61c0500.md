---
item_id: "cae5ff8a-40ad-4daa-8e1b-c6870dc990be"
platform: article
external_id: "9d0aa61c0500"
...
# Copy paste de websites: violação ao direito do autor? (Jusbrasil)

🔗 https://www.jusbrasil.com.br/artigos/copy-paste-de-websites-violacao-ao-direito-do-autor/121943976

## Resumo

Artigo jurídico de Vinícius Tini Garcia que responde diretamente se copiar um site alheio é infração, e conclui que sim, por duas vias somadas. A primeira é a Lei 9.609/98, que dá ao programa de computador o mesmo regime das obras literárias — e um website é, na definição do autor, um conjunto organizado de instruções em linguagem codificada, portanto software. A segunda é a Lei 9.610/98, cujo artigo 7º, inciso XIII, protege expressamente as obras que, 'por sua seleção, organização ou disposição de seu conteúdo, constituam uma criação intelectual' — ou seja, o layout e a arquitetura da página, não só o código. O ponto central do texto é que as duas proteções são independentes: copiar a lógica do site e trocar só a identidade visual viola, e copiar apenas a identidade visual sem tocar no código-fonte também viola. O que a lei não protege é a ideia ou a função — o que se protege é a expressão, a materialização perceptível daquela ideia; um programa não é cópia de outro só por ter a mesma finalidade. O artigo traz duas decisões do TJSP: a Apelação 0119580-83.2007.8.26.0000, em que uma clínica odontológica reproduziu o conteúdo do site de outra clínica do mesmo ramo e foi condenada a retirar o conteúdo sob multa diária mais dano moral in re ipsa; e a Apelação Cível 122.616-4/6 (Mandic × Intervale), em que a perícia constatou reprodução do HTML original 'depois de algumas maquiagens que configuram a imitação', caracterizando concorrência desleal, com o acórdão registrando que mesmo a cópia parcial é contrafação. O autor acrescenta que a proteção independe de registro, mas exige prova de anterioridade, e que a cópia de identidade visual (o 'look and feel') pode gerar confusão no consumidor e escalar de direito autoral para concorrência desleal e aproveitamento parasitário.

## Tópicos

- **Website como software** — A Lei 9.609/98 protege programa de computador com o regime das obras literárias; o site é conjunto organizado de instruções em linguagem codificada.
- **Layout protegido pelo art. 7º XIII** — A Lei 9.610/98 protege obras que por sua seleção, organização ou disposição de conteúdo constituam criação intelectual — alcança a estrutura da página.
- **As duas violações são independentes** — Copiar o código e trocar o visual viola; copiar o visual sem tocar no código também viola.
- **Ideia não, expressão sim** — A finalidade e o algoritmo não são protegidos; o que se protege é a materialização perceptível — mesma função não faz de um software cópia do outro.
- **Caso clínica odontológica** — Apelação 0119580-83.2007.8.26.0000: réu do mesmo ramo reproduziu conteúdo do site da autora; condenado a retirar sob multa diária e a pagar dano moral in re ipsa.
- **Caso Mandic × Intervale** — Apelação Cível 122.616-4/6: perícia achou o HTML original reproduzido com 'maquiagens'; TJSP viu contrafação e concorrência desleal, e registrou que cópia parcial já é contrafação.
- **Escalada para concorrência desleal** — A cópia do look and feel confunde o consumidor e desvia clientela, somando propriedade industrial ao direito autoral.

## Ferramentas citadas

- **Lei 9.610/98**: lei de direitos autorais; art. 7º XIII alcança seleção, organização e disposição do conteúdo
- **Lei 9.609/98**: lei do software; equipara programa de computador a obra literária, proteção independe de registro
- **Biblioteca Nacional**: onde um site pode ser registrado como obra, para prova de anterioridade

## Pontos-chave

- Website é protegido em duas camadas independentes: o código-fonte e a organização visual do conteúdo.
- Art. 7º XIII da Lei 9.610/98 protege 'seleção, organização ou disposição do conteúdo' — o layout entra aqui.
- Copiar só o visual, sem copiar código, já é violação segundo o artigo.
- Cópia parcial também é contrafação — o acórdão do TJSP diz isso com todas as letras.
- 'Maquiagens' sobre um site copiado não descaracterizam a imitação; foi exatamente o argumento derrubado no caso Mandic.
- Ideia e finalidade não são protegidas; expressão é. Dois sites podem ter a mesma função sem que um seja cópia do outro.
- A proteção nasce com a obra e independe de registro, mas a prova de anterioridade é o que decide o litígio.
- Copiar site de empresa do MESMO ramo agrava: sai de direito autoral e entra em concorrência desleal e desvio de clientela.
- No caso da clínica odontológica o dano moral foi considerado in re ipsa — não precisou provar prejuízo.
- Sites montados a partir de templates customizados também geram identidade própria protegível, segundo o autor.

## Como aplicar

É o item que corrige a régua que estava sendo usada: layout NÃO é terreno livre no Brasil. Ao usar o ai-website-cloner-template instalado em /home/crazu/projetos/ai-website-cloner-template, trocar texto, foto e logo não basta se a disposição do conteúdo for reconhecivelmente a do alvo — foi exatamente o argumento das 'maquiagens' derrubado no caso Mandic. A leitura segura passa a ser: clonar site do próprio cliente (migração autorizada) ou usar o clone só como referência de estrutura, redesenhando a composição. E a regra de nunca clonar concorrente do cliente na mesma praça deixa de ser prudência e vira jurisprudência.

## 🪖 Shaka diz

Isso é evidência, não opinião: dois acórdãos do TJSP, um deles com perícia técnica no HTML. Registre o que muda para você — a tese de que layout é livre não se sustenta aqui, porque o artigo 7º inciso XIII protege a disposição do conteúdo, e o réu do caso Mandic tentou justamente a defesa das maquiagens e perdeu. Clonar o site do próprio cliente é migração autorizada e está fora disso. Clonar terceiro do mesmo ramo é o caso condenado, e nesse ponto não há margem de interpretação.
...
###### Você criou um site e suspeita que outro site copiou seu layout ou código?
...
A lei 9.610/98, dispõe sobre a proteção aos direitos autorais, em seu artigo 7º define:
...
[2] Art.5ªª, inciso XXVII daConstituição Federall.
...
Imagine patentear uma CSS? Ou um tom de vermelho degradê feito no JavaFX...
...
É muito difícil pensar em metodologias e leiautes sendo registrados. Novos métodos de criptografia, programação em camadas, MVC... Bem difícil. Já coisas como MP3, produtos em código-fonte proprietário, tipo COBOL, Delphy, Ou até mesmo Java no ambiente WebsPhere, já tem direitos reservados, aí você compra a permissão de usar a IDE e vincular suas criações ao produto dessas empresas. Agora, se usar código aberto, GNU ou qualquer licença de software livre, não vai dar certo. E a responsabilidade de venda de software livre como se fosse pago, rachou o Linux por exemplo, criando RedHat e Fedora, e o Linus também, livre, mas com sérios problemas por ter um kernel baseado em Unix (Minix). Até o SAP tem problemas, pois várias pessoas usam o MiniSAP para fazer seu próprio MySAP e quebrar mais uma patente/direito autoral assegurado.
 ...
 Uma moral inabalável, quase ser um herói da honestidade.
